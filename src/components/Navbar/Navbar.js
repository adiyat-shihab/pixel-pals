...
const Navbar = () => {
  return (
    <div>
      <nav class="relative px-4 py-4  flex justify-between items-center bg-neutral-800">
        <Link href={"/home"}>
        ...
        <div class="lg:hidden">
          <button className="navbar-burger flex items-center text-blue-600 p-3">
            <svg
              class="block h-4 w-4 bg-gray-700 text-gray-700"
              viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg"
            >
        ...
        <ul class="hidden absolute top-1/2 left-1/2 text-gray-100 transform -translate-y-1/2 -translate-x-1/2 lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
          <li>
